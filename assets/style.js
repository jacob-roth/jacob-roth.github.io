...
const subheaderfontsize = "16pt";
const subheaderdecoration = "none";
const namecolor = accentcolor;
...
$(".talktitle").css("color", selfcolor);
$(".talktitle").css("font-weight", selfweight);
$(".talktitle").css("text-decoration", selfdecoration);
$(".talktitle").css("font-style", selfstyle);
